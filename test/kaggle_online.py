"""Build the offline Kaggle bundle for attention-anchor retrieval KD.
...
BUNDLE = WORKING / "anchor_bundle" / "offline_bundle"
...
BRANCH = "experiment/attention-anchor-retrieval-kd"
# Pinned training source; this builder is distributed separately.
COMMIT = "1128b4789abe21b77eebbcc00612c7fcca552c67"
TASK = "attention_anchor_retrieval_kd"
...
required_paths = (
    ...
    project / "src" / "attention_anchor.py",
    project / "src" / "attention_anchor_cache.py",
    project / "tests" / "test_attention_anchor.py",
    project / "tests" / "test_attention_anchor_cache.py",
    project / "test" / "kaggle_anchor_prepare.ipy",
    project / "test" / "kaggle_anchor_train.ipy",
...
print("=" * 70)
print("ONLINE ATTENTION-ANCHOR RETRIEVAL KD BUNDLE COMPLETE")
print("=" * 70)
print("Bundle:", BUNDLE)
print("Branch:", BRANCH)
