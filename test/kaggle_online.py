"""Build the offline Kaggle bundle for mask-guided response KD.
...
BUNDLE = WORKING / "mask_guided_bundle" / "offline_bundle"
...
BRANCH = "experiment/mask-guided-response-kd"
# Pinned training source; this builder is distributed separately.
COMMIT = "666d8b5c9cd2db3ef6f9e7a6ba72f9b2cf1fcf62"
TASK = "mask_guided_response_kd"
...
required_paths = (
    ...
    project / "src" / "mask_guided.py",
    project / "src" / "mask_guided_cache.py",
    project / "src" / "mask_guided_diagnostics.py",
    project / "tests" / "test_mask_guided.py",
    project / "tests" / "test_mask_guided_cache.py",
    project / "test" / "kaggle_mask_prepare.ipy",
    project / "test" / "kaggle_mask_guided_train.ipy",
    project / "test" / "kaggle_mask_random_train.ipy",
    project / "test" / "kaggle_mask_embedding_train.ipy",
    project / "test" / "kaggle_main_baseline_train.ipy",
    project / "test" / "kaggle_mask_report.py",
    dfn_target,
    student_target,
)
...
print("=" * 70)
print("ONLINE MASK-GUIDED RESPONSE KD BUNDLE COMPLETE")
print("=" * 70)
print("Bundle:", BUNDLE)
print("Branch:", BRANCH)
