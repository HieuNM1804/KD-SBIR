"""Build the pinned offline Kaggle bundle for CoRe-KD.
...
BUNDLE = (
    WORKING
    / ("core_kd_bundle_" + datetime.now(UTC).strftime("%Y%m%d_%H%M%S_%f"))
    / "offline_bundle"
)
...
COMMIT = "dc6d4e75e2ea7bf9b064a3fb42b348954aff8268"
...
required_paths = (
    ...
    project / "tests" / "test_core_kd.py",
    project / "test" / "kaggle_core_compare.py",
    project / "docs" / "core_kd.md",
    dfn_target,
    student_target,
)
...
print("=" * 70)
print("ONLINE CORE-KD BUNDLE COMPLETE")
print("=" * 70)
print("Bundle:", BUNDLE)
print("Branch:", BRANCH)
