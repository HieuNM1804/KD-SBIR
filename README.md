...
12, the ViT-L/14 teacher has 73,728 trainable prompt parameters.
...
!python -m src.train \
    ...
    --seed 42 \
    --exp_name openai_l14_teacher_visual_student_visual_only \
    --progress
```
