...
if __name__ == "__main__":
    ...
    parser.add_argument('--lambda_text_kd', type=float, default=1.0,
                        help='Trọng số relational KD giữa student text prompts và teacher text prompts.')
    parser.add_argument('--text_kd_temperature', type=float, default=0.07,
                        help='Temperature cho text relational KD.')
                        
    parser.add_argument('--exp_name', type=str, default='no_cls_text_kd')
