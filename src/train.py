...
if __name__ == "__main__":
    ...
    parser.add_argument("--lambda_nt_xent", type=float, default=1.0,
                        help="Trọng số cho NT-Xent loss sketch-photo của student.")
    parser.add_argument("--nt_xent_temperature", type=float, default=0.07,
                        help="Temperature cho NT-Xent loss của student.")
    ...
    parser.add_argument('--teacher_adapter_ckpt', type=str, default='',
                        help='Checkpoint modality adapter đã fine-tune cho EVA01-g-14.')
    parser.add_argument('--joint_teacher_adapter', action='store_true', default=True,
                        help='Train EVA01-g-14 sketch/photo adapters jointly with the student.')
    ...
    parser.add_argument('--lambda_teacher_nt_xent', type=float, default=1.0,
                        help='Trọng số teacher-adapter NT-Xent loss trên nhánh ablation này.')
    ...
    parser.add_argument('--teacher_nt_xent_temperature', type=float, default=0.07)
    ...
    parser.add_argument('--exp_name', type=str, default='teacher_adapter_ntxent_baseline')
